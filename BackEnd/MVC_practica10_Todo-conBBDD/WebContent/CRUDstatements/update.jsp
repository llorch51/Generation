...
<!--   <div class="collapse navbar-collapse justify-content-center" id="navbarNav"> -->
    <ul class="navbar-nav nav-tab nav-fill nav-pills">
      ...
      <li class="nav-item">
        <a class="nav-link disabled" href="update.jsp">UPDATE</a>
      </li>
      <li class="nav-item">
			...
			<div class="col align-self-center">
				<form action="../UpdateServlet" method="post">
					<div class="form-group">
						<label for="txtProducto">ID Producto</label> <input type="text"
							class="form-control" id="txtProducto" placeholder="" name="txtID">
					</div>
					<div class="form-group">
